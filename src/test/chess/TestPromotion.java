...
public class TestPromotion {
    public static void main(String[] args) {
         ...
         * 
         * System.out.println(pawn.willPromote(b, new FileRank("" + 'g' + 8),
         * b.getPiece(new FileRank("" + 'g' + 7)), b.getPiece(new FileRank("" + 'g' +
         * 7)).getFileRank(),'B'));
         * 
         * System.out.println(b.getPiece(new FileRank("" + 'g' + 8)));
         * 
         * b.addToBoard(b, new FileRank("c4"), new Pawn(Piece.Color.white, new
         * FileRank("c4")));
         * System.out.println(b);
         */
    }
