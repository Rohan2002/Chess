...
public class Knight extends Piece {
    ...
    public boolean canMove(Board b, Piece nextPiece, FileRank nfr) {
        ...
        boolean upLShape = (Math.abs(nfr.getFile() - curr.getFile()) == 1 && Math.abs(nfr.getRank() - curr.getRank()) == 2);
        boolean downLShape = (Math.abs(nfr.getFile() - curr.getFile()) == 2 && Math.abs(nfr.getRank() - curr.getRank()) == 1);
